...
@section('content')
    ...
    <x-auth-session-status class="mb-4" :status="session('status')" />
        <div class="h-screen flex items-center justify-end"
            ...
            <form method="POST" action="{{ route('secretary.patient.store') }}" onsubmit="return validatePasswords();"
                ...
                <div class="space-y-4">
                    ...
                    <!-- Patient Name -->
                    <div>
                        <label for="name" class="flex items-center mb-1 text-sm font-medium">Patient Name</label>
                    ...
                    <!-- Email -->
                    <div>
                        <label for="email" class="flex items-center mb-1 text-sm font-medium">Patient Email</label>

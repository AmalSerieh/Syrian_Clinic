...
class FamilyHistoriesPolicy
{
    ...
    {
        return $user->doctor || (
            $user->patient && $familyHistory->patient_record_id === $user->patient->patient_record->id
        );
    }
    ...
    public function create(User $user, Patient_record $record): bool
    {
        ...
        if ($user->patient) {
            return !$record->family_history_submitted;
        }
        return false;
    }
    ...
    public function update(User $user, FamilyHistory $familyHistory): bool
    {
        ...
        $patient = $familyHistory->patient_record->patient;
     ...
     */
    public function restore(User $user, FamilyHistory $familyHistory): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(User $user, FamilyHistory $familyHistory): bool
    {
        return false;
    }
}

...
class MedicationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
         return [
            ...
            'med_total_quantity' => $this->med_total_quantity,//العدد الكلي للدواء المتوقع استهلاكه خلال المدة المحددة (يُحسب تلقائيًا). مثلًا هنا: أخذ الدواء أسبوعيًا لمدة معينة → النتيجة كانت 4 جرعات.
